...
namespace TechCareer.WernerHeisenberg.Northwind.Domain.Context;
...
public partial class NorthwindContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        optionsBuilder.UseSqlServer(
            "Server=192.168.50.101,1433;Initial Catalog=NorthwindDb;trusted_connection=false;Integrated Security=False;Persist Security Info=False;User ID=sa;Password=Abc1234567?;Encrypt=False");
    }
